			...
			<tbody>
				<c:forEach items="${carrinhoCompras.itens}" var="item">
					<tr>
						...
						<td class="numeric-cell">${carrinhoCompras.getQuantidade()}</td>
<%-- 						<td><input type="number" min="0" readonly="readonly" id="quantidade" name="quantidade" value="${carrinhoCompras.getQuantidade(item)}" /></td> --%>
